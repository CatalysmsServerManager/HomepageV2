export const featureData = [
  ...
  [
    ...
    ['In-game commands', 'Player made teleports, in-game support system, ... Custom commands to expose console commands to players in a controlled way'],
  ...
  [
    ...
    ['Permissions and roles', 'Give users special permission on the web panel or in-game.'],
